...
<template>
  <!-- <div class="bg-white rounded-2xl shadow hover:shadow-xl transition overflow-hidden group">
    ...
    <img :src="data.image" class="h-40 w-full object-cover group-hover:scale-105 transition" />
    ...
    <div class="rounded-sm overflow-hidden bg-white mx-2  relative">
          ...
          >
           <button
            ...
            @click="prev"
            class=" absolute left-3  mt-10  -translate-y-1/2 bg-white/80 h-7 w-7 rounded-full shadow"
        >
            ‹
        </button>
